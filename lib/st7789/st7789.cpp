...
//#ifndef ST7789_NO_CS
    #define PIN_CS 3  // PC2
//#endif
#define PIN_RESET 7  // PC3
#define PIN_DC    0  // PC4
#define SPI_SCLK  5  // PC5
#define SPI_MOSI  6  // PC6

#define DATA_MODE()    (GPIOD->BSHR |= 1 << PIN_DC)  // DC High
#define COMMAND_MODE() (GPIOD->BCR |= 1 << PIN_DC)   // DC Low
...
#ifdef PLATFORMIO
    #ifndef CTLR1_SPE_Set
        #define CTLR1_SPE_Set      ((uint16_t)0x0040)
    #endif
    #ifndef GPIO_CNF_OUT_PP
        #define GPIO_CNF_OUT_PP    0x00
    #endif
    #ifndef GPIO_CNF_OUT_PP_AF
...
void tft_print_char(char c, uint8_t font_scale)
{
    ...
    const uint8_t* start = &fontk[((uint8_t)c) << 3]; // 8bytes/char
